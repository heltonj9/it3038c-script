...
var server = http.createServer(function (req, res) {
    if (req.url === "/") {
    ...
    else if (req.url.match("/my-file.txt")) {
        ...
        logdata = [fs.readFile('./node/public/my-file.txt', 'utf8', function(err, data) {
            if (err) throw err;
            console.log(data);
        })];
        html = `
        ...
        <body>
            <h1>Hello! Welcome to my Node Site!</h1>
            <p>Hostname: ${console.log(fs.readFile('./node/public/my-file.txt'} </p>
        </body>
